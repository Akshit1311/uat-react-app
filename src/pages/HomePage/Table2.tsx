    ...
    <>
      <div className="d-flex">
        ...
        <div className="w-100 data-table p-0 m-0">
          ...
          <div style={{ color: '#0177FA', cursor: 'pointer', fontFamily: 'Montserrat', fontSize: '14px', fontWeight: 'bold' }} className="my-4 d-flex align-items-center justify-content-center">
              View More
          </div>
        </div>
      </div>
