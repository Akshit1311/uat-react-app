      ...
      >
        ...
        <g style={{ transform: 'scale(1.42)' }}>
          <circle
            ...
            r="5.3065996645686395"
          >
            <title>0.2% from Goa</title>
          </circle>
          <circle
            transform="translate(161.08088331933308,321.57112579166403)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="17.9086571244189"
          >
            <title>2.6% from Telangana</title>
          </circle>
          <circle
            transform="translate(364.32148487075466,185.6426228249223)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="13.644046320648432"
          >
            <title>1.5% from Assam</title>
          </circle>
          <circle
            transform="translate(379.63129368104353,212.2324690066217)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.525955088890711"
          >
            <title>0.5% from Manipur</title>
          </circle>
          <circle
            transform="translate(366.0234218936515,420.1156161453542)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Andaman And Nicobar Islands</title>
          </circle>
          <circle
            transform="translate(300.247024241958,165.81435472624932)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.9496835316262997"
          >
            <title>0.1% from Sikkim</title>
          </circle>
          <circle
            transform="translate(365.17936142195873,226.97428904708215)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="16.670932787339765"
          >
            <title>2.3% from Aizawl</title>
          </circle>
          <circle
            transform="translate(370.6433813730695,231.48095217954912)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.878775382679628"
          >
            <title>0.3% from Champhai</title>
          </circle>
          <circle
            transform="translate(362.82516995549315,220.82586447638124)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.2249030993194197"
          >
            <title>0.1% from Kolasib</title>
          </circle>
          <circle
            transform="translate(362.5782056525802,249.85128742506603)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.6221540552549665"
          >
            <title>0.1% from Lawngtlai</title>
          </circle>
          <circle
            transform="translate(361.6960977667406,240.43371704410754)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.807688518377254"
          >
            <title>0.5% from Lunglei</title>
          </circle>
          <circle
            transform="translate(358.9211765615487,228.06292215142895)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.61426753904728"
          >
            <title>0.3% from Mamit</title>
          </circle>
          <circle
            transform="translate(366.98418709073565,249.92416079116967)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.475629439396553"
          >
            <title>0.1% from Saiha</title>
          </circle>
          <circle
            transform="translate(366.1628648055923,235.86399446416007)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.657326790837295"
          >
            <title>0.4% from Serchhip</title>
          </circle>
          <circle
            transform="translate(369.5815258542625,232.15324232463274)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.8973665961010278"
          >
            <title>0% from Khawzawl</title>
          </circle>
          <circle
            transform="translate(366.6261961629517,240.96207286271886)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.5777087639996634"
          >
            <title>0.1% from Hnahthial</title>
          </circle>
          <circle
            transform="translate(174.8629046397115,391.3897992365705)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.585696017507575"
          >
            <title>0.3% from Thiruvallur</title>
          </circle>
          <circle
            transform="translate(179.04423198526197,394.7967280302992)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="10.67707825203131"
          >
            <title>0.9% from Chennai</title>
          </circle>
          <circle
            transform="translate(146.71042462813185,402.5887107970413)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.857460304397182"
          >
            <title>0.1% from Krishnagiri</title>
          </circle>
          <circle
            transform="translate(163.3829911735087,403.45746294900573)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.7841775856849003"
          >
            <title>0.1% from Tiruvannamalai</title>
          </circle>
          <circle
            transform="translate(149.156202968896,408.56858471107637)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.939543120718442"
          >
            <title>0.1% from Dharmapuri</title>
          </circle>
          <circle
            transform="translate(149.6176614989541,414.8715115921707)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.864400920692205"
          >
            <title>0.4% from Salem</title>
          </circle>
          <circle
            transform="translate(137.6161808942851,417.120324204388)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.904429138147801"
          >
            <title>0.5% from Erode</title>
          </circle>
          <circle
            transform="translate(126.3231680208624,418.14882630380197)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.8987177379235853"
          >
            <title>0.1% from Nilgiris</title>
          </circle>
          <circle
            transform="translate(148.312919238976,420.20848572675914)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.286493458200685"
          >
            <title>0.3% from Namakkal</title>
          </circle>
          <circle
            transform="translate(159.43753974136817,420.88716181176625)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.649242250247064"
          >
            <title>0% from Perambalur</title>
          </circle>
          <circle
            transform="translate(131.1896859994504,426.8034367373369)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="10.174477873581523"
          >
            <title>0.8% from Coimbatore</title>
          </circle>
          <circle
            transform="translate(154.72223609541257,426.4277449008563)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.912698199637793"
          >
            <title>0.3% from Tiruchirappalli</title>
          </circle>
          <circle
            transform="translate(164.54459209235313,422.5295510592672)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.8973665961010278"
          >
            <title>0% from Ariyalur</title>
          </circle>
          <circle
            transform="translate(137.55141355787086,427.3621555555954)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.709734106958553"
          >
            <title>0.5% from Tiruppur</title>
          </circle>
          <circle
            transform="translate(164.4948667804052,429.9933734890539)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.362389488234746"
          >
            <title>0.3% from Thanjavur</title>
          </circle>
          <circle
            transform="translate(148.2512166769911,427.30023316677915)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.1182520563948"
          >
            <title>0.1% from Karur</title>
          </circle>
          <circle
            transform="translate(168.63594675419736,429.3738418228603)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.551922670696417"
          >
            <title>0.2% from Thiruvarur</title>
          </circle>
          <circle
            transform="translate(143.58743501209563,434.1558620557525)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.9120439557122073"
          >
            <title>0.1% from Dindigul</title>
          </circle>
          <circle
            transform="translate(146.38863540995715,441.02486048377426)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.8987177379235853"
          >
            <title>0.1% from Madurai</title>
          </circle>
          <circle
            transform="translate(137.97345330409013,441.657745576573)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6"
          >
            <title>0% from Theni</title>
          </circle>
          <circle
            transform="translate(144.78475459411666,447.42347202958007)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.172556098240043"
          >
            <title>0% from Virudhunagar</title>
          </circle>
          <circle
            transform="translate(146.3284707401743,456.41330104845696)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.3226495451672293"
          >
            <title>0.1% from Thoothukkudi</title>
          </circle>
          <circle
            transform="translate(136.81198198341224,465.13087984499845)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.019950248448356"
          >
            <title>0.1% from Kanyakumari</title>
          </circle>
          <circle
            transform="translate(168.8296901331173,408.1689134875591)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.0854497241083023"
          >
            <title>0.1% from Viluppuram</title>
          </circle>
          <circle
            transform="translate(167.5876930098662,416.88572610145263)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="4.2047592083257275"
          >
            <title>0.1% from Cuddalore</title>
          </circle>
          <circle
            transform="translate(159.1947084218812,434.5286808980495)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.3466401061363023"
          >
            <title>0.1% from Pudukkottai</title>
          </circle>
          <circle
            transform="translate(154.89307044179984,441.01919459656773)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.286335345030996"
          >
            <title>0.1% from Sivaganga</title>
          </circle>
          <circle
            transform="translate(156.25858331904334,448.1897200427348)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.979898987322333"
          >
            <title>0% from Ramanathapuram</title>
          </circle>
          <circle
            transform="translate(171.69794010430547,427.7399154117438)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.655133376499413"
          >
            <title>0.1% from Nagapattinam</title>
          </circle>
          <circle
            transform="translate(161.1897053327466,413.0124341510412)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.8"
          >
            <title>0.1% from Kallakurichi</title>
          </circle>
          <circle
            transform="translate(138.25591905492257,453.55020356393305)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.7663521732655694"
          >
            <title>0% from Tenkasi</title>
          </circle>
          <circle
            transform="translate(140.44624125183023,461.194405731453)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.2249030993194197"
          >
            <title>0.1% from Tirunelveli</title>
          </circle>
          <circle
            transform="translate(160.1748571977483,396.3761024711617)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.676955262170047"
          >
            <title>0.1% from Vellore</title>
          </circle>
          <circle
            transform="translate(167.69129488760274,395.5783595704647)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.884441020371191"
          >
            <title>0.1% from Ranipet</title>
          </circle>
          <circle
            transform="translate(155.5499245646502,401.2588863319554)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.465765601187591"
          >
            <title>0% from Tirupathur</title>
          </circle>
          <circle
            transform="translate(173.1939906317498,397.46133446833625)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.106858133921481"
          >
            <title>0.2% from Kancheepuram</title>
          </circle>
          <circle
            transform="translate(175.6322563689765,401.32893453633585)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="8.690224392960172"
          >
            <title>0.6% from Chengalpattu</title>
          </circle>
          <circle
            transform="translate(178.7926447354422,269.3094833792795)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Gondia</title>
          </circle>
          <circle
            transform="translate(172.10141141385913,269.8832560590625)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Bhandara</title>
          </circle>
          <circle
            transform="translate(109.36781563200506,272.8004948142744)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.8944271909999159"
          >
            <title>0% from Jalgaon</title>
          </circle>
          <circle
            transform="translate(154.88876863885335,274.97361123091315)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.6928203230275508"
          >
            <title>0% from Wardha</title>
          </circle>
          <circle
            transform="translate(122.84915057284095,279.37452649195825)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.7483314773547883"
          >
            <title>0% from Buldhana</title>
          </circle>
          <circle
            transform="translate(74.51319706854024,280.8381253377155)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.8761663039293717"
          >
            <title>0% from Valsad</title>
          </circle>
          <circle
            transform="translate(132.41404057571577,275.7315442588607)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.16619037896906"
          >
            <title>0% from Akola</title>
          </circle>
          <circle
            transform="translate(273.14856211880294,272.0428585355366)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.3664319132398464"
          >
            <title>0% from Bhadrak</title>
          </circle>
          <circle
            transform="translate(256.86196309605816,274.4992206988606)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.5491933384829668"
          >
            <title>0% from Dhenkanal</title>
          </circle>
          <circle
            transform="translate(266.14712085205724,274.25001778825737)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.85657137141714"
          >
            <title>0.1% from Jajpur</title>
          </circle>
          <circle
            transform="translate(231.90680497179346,272.8752791940598)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.9380831519646858"
          >
            <title>0% from Subarnapur</title>
          </circle>
          <circle
            transform="translate(213.52087460634678,280.1488089527608)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.7204650534085253"
          >
            <title>0% from Nuapada</title>
          </circle>
          <circle
            transform="translate(222.27674262491993,278.38184702266483)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Balangir</title>
          </circle>
          <circle
            transform="translate(88.4934147275567,283.4595077559864)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.829348431585549"
          >
            <title>0.4% from Nashik</title>
          </circle>
          <circle
            transform="translate(236.97851873534282,277.3779698938158)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.649242250247064"
          >
            <title>0% from Boudh</title>
          </circle>
          <circle
            transform="translate(179.27582279046553,290.7706725194299)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.4898979485566356"
          >
            <title>0% from Gadchiroli</title>
          </circle>
          <circle
            transform="translate(134.7034511564707,283.8249292812572)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Washim</title>
          </circle>
          <circle
            transform="translate(259.44983110445077,280.42462705728553)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.440588203494176"
          >
            <title>0.2% from Cuttack</title>
          </circle>
          <circle
            transform="translate(167.4209371990129,285.69367953971425)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.16619037896906"
          >
            <title>0% from Chandrapur</title>
          </circle>
          <circle
            transform="translate(148.63998150959353,286.1596151813267)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Yavatmal</title>
          </circle>
          <circle
            transform="translate(235.1675477550263,285.46209853622565)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Kandhamal</title>
          </circle>
          <circle
            transform="translate(116.53339497405673,290.44082351439386)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.3564659966250534"
          >
            <title>0% from Jalna</title>
          </circle>
          <circle
            transform="translate(249.1921078520123,284.15448082031185)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6"
          >
            <title>0% from Nayagarh</title>
          </circle>
          <circle
            transform="translate(192.2671294751406,285.27682983214316)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.6324555320336758"
          >
            <title>0% from Uttar Bastar Kanker</title>
          </circle>
          <circle
            transform="translate(256.7295812526627,286.0877127904691)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="12.149074038789951"
          >
            <title>1.2% from Khordha</title>
          </circle>
          <circle
            transform="translate(221.32487921859922,289.6201628622339)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.3266499161421599"
          >
            <title>0% from Kalahandi</title>
          </circle>
          <circle
            transform="translate(268.83417531491096,284.02140143571387)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.7422618401604177"
          >
            <title>0.1% from Jagatsinghpur</title>
          </circle>
          <circle
            transform="translate(259.8681385092383,289.4053910870168)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.349468024894146"
          >
            <title>0% from Puri</title>
          </circle>
          <circle
            transform="translate(97.29382476365728,299.9182342789904)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="13.538094400616359"
          >
            <title>1.5% from Ahmednagar</title>
          </circle>
          <circle
            transform="translate(209.96190952650156,294.12289677768337)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Nabarangapur</title>
          </circle>
          <circle
            transform="translate(132.9073062308878,293.37980488092376)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.2328828005937955"
          >
            <title>0% from Hingoli</title>
          </circle>
          <circle
            transform="translate(227.39594410150627,297.4210642744312)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.465765601187591"
          >
            <title>0% from Rayagada</title>
          </circle>
          <circle
            transform="translate(140.663868508199,301.2488275339884)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.3856406460551016"
          >
            <title>0% from Nanded</title>
          </circle>
          <circle
            transform="translate(126.76013702486578,298.95892673052606)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6"
          >
            <title>0% from Parbhani</title>
          </circle>
          <circle
            transform="translate(88.38265613686768,309.7825696194836)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="16.569852141766383"
          >
            <title>2.2% from Pune</title>
          </circle>
          <circle
            transform="translate(114.37303767238036,303.9195308926791)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.2619012860600183"
          >
            <title>0.1% from Beed</title>
          </circle>
          <circle
            transform="translate(70.90789923058668,301.65009852738154)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="19.332873557751313"
          >
            <title>3.1% from Mumbai</title>
          </circle>
          <circle
            transform="translate(215.5716732609179,305.9866779632503)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.0954451150103321"
          >
            <title>0% from Koraput</title>
          </circle>
          <circle
            transform="translate(234.64890238316104,309.4372756605425)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.867815921162743"
          >
            <title>0.1% from Srikakulam</title>
          </circle>
          <circle
            transform="translate(225.31170707151634,311.35155400234146)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.262741699796952"
          >
            <title>0% from Vizianagaram</title>
          </circle>
          <circle
            transform="translate(128.0963273175977,312.7674626501901)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.5612496949731396"
          >
            <title>0.1% from Latur</title>
          </circle>
          <circle
            transform="translate(117.49074250573027,315.6408549726649)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.730951621235526"
          >
            <title>0.1% from Osmanabad</title>
          </circle>
          <circle
            transform="translate(204.27976550847632,314.6232421009121)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Malkangiri</title>
          </circle>
          <circle
            transform="translate(109.27935979891637,321.7463344962827)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.939696961966999"
          >
            <title>0.3% from Solapur</title>
          </circle>
          <circle
            transform="translate(215.2723612132063,320.264986910129)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.072458299147443"
          >
            <title>0.1% from Visakhapatnam</title>
          </circle>
          <circle
            transform="translate(90.05706257699256,323.74276667415603)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.151422599691879"
          >
            <title>0.3% from Satara</title>
          </circle>
          <circle
            transform="translate(79.5197703356752,329.8601698283685)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.741657386773941"
          >
            <title>0.1% from Ratnagiri</title>
          </circle>
          <circle
            transform="translate(129.4700000740775,330.0607464896436)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.2649110640673515"
          >
            <title>0% from Kalaburagi</title>
          </circle>
          <circle
            transform="translate(98.82561908969147,332.29146222223915)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.170899448216605"
          >
            <title>0.3% from Sangli</title>
          </circle>
          <circle
            transform="translate(89.78163862929928,342.06556971072405)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.0983866769659336"
          >
            <title>0.1% from Kolhapur</title>
          </circle>
          <circle
            transform="translate(187.43582805306303,340.94160159297047)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.939773296511683"
          >
            <title>0.5% from Krishna</title>
          </circle>
          <circle
            transform="translate(99.52700527749165,347.5058581751041)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.5768197453450252"
          >
            <title>0.1% from Belagavi</title>
          </circle>
          <circle
            transform="translate(130.26126764612818,339.7687749755064)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Yadgir</title>
          </circle>
          <circle
            transform="translate(111.3870736054547,346.06775476836395)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Bagalkote</title>
          </circle>
          <circle
            transform="translate(83.64704853843389,347.4142212485613)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="5.2687759489277965"
          >
            <title>0.2% from Sindhudurg</title>
          </circle>
          <circle
            transform="translate(176.8703816119141,344.86080057950176)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.019950248448356"
          >
            <title>0.1% from Guntur</title>
          </circle>
          <circle
            transform="translate(203.49857119856122,329.81455588911166)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="8.653323061113575"
          >
            <title>0.6% from East Godavari</title>
          </circle>
          <circle
            transform="translate(130.03131725084785,347.924251088779)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Raichur</title>
          </circle>
          <circle
            transform="translate(168.524314498883,355.1693192569664)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="5.4332310828824495"
          >
            <title>0.2% from Prakasam</title>
          </circle>
          <circle
            transform="translate(146.2081954446408,356.5083718674732)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.414213562373095"
          >
            <title>0% from Kurnool</title>
          </circle>
          <circle
            transform="translate(120.14076032256396,356.06332461906914)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.16619037896906"
          >
            <title>0% from Koppal</title>
          </circle>
          <circle
            transform="translate(124.5860164926518,363.00306058313095)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.006659275674582"
          >
            <title>0.1% from Ballari</title>
          </circle>
          <circle
            transform="translate(104.43732130447636,358.7043872110872)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Dharwad</title>
          </circle>
          <circle
            transform="translate(96.52886403733734,367.71090367585407)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.006659275674582"
          >
            <title>0.1% from Uttara Kannada</title>
          </circle>
          <circle
            transform="translate(108.37600349588612,368.67000278897325)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Haveri</title>
          </circle>
          <circle
            transform="translate(139.95395304238315,372.4588600099256)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.0199009876724157"
          >
            <title>0% from Anantapur</title>
          </circle>
          <circle
            transform="translate(171.81170995163754,373.50543399356945)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.768882040742382"
          >
            <title>0.3% from S.p.s. Nellore</title>
          </circle>
          <circle
            transform="translate(124.39160937293758,377.3193738954332)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.9595917942265424"
          >
            <title>0% from Chitradurga</title>
          </circle>
          <circle
            transform="translate(116.12468976021295,373.6771156261026)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3266499161421599"
          >
            <title>0% from Davanagere</title>
          </circle>
          <circle
            transform="translate(105.30989464216633,379.0922380840942)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.059411708155671"
          >
            <title>0.1% from Shivamogga</title>
          </circle>
          <circle
            transform="translate(100.2804253427249,387.4108409850735)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.9595917942265424"
          >
            <title>0% from Udupi</title>
          </circle>
          <circle
            transform="translate(112.31090572187117,388.0649303795887)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.349468024894146"
          >
            <title>0% from Chikkamagaluru</title>
          </circle>
          <circle
            transform="translate(143.92736792773792,386.07649297605195)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.2649110640673515"
          >
            <title>0% from Chikkaballapura</title>
          </circle>
          <circle
            transform="translate(118.41962452238495,394.97804235821565)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.31740662898458"
          >
            <title>0.2% from Hassan</title>
          </circle>
          <circle
            transform="translate(149.42934867306772,392.798776748085)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.9797958971132712"
          >
            <title>0% from Kolar</title>
          </circle>
          <circle
            transform="translate(139.94344011357865,391.45660792578065)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.833030277982336"
          >
            <title>0% from Bengaluru Rural</title>
          </circle>
          <circle
            transform="translate(105.80490184978359,397.2020986864824)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.698936049788292"
          >
            <title>0.2% from Dakshina Kannada</title>
          </circle>
          <circle
            transform="translate(140.3184444846752,395.5983779337321)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="22.85782141849918"
          >
            <title>4.3% from Bengaluru Urban</title>
          </circle>
          <circle
            transform="translate(104.48585513956526,403.2155418683179)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="16.387800340497197"
          >
            <title>2.2% from Kasaragod</title>
          </circle>
          <circle
            transform="translate(113.94806738214461,405.0969465957367)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.4525353003264136"
          >
            <title>0.1% from Kodagu</title>
          </circle>
          <circle
            transform="translate(133.07794227285564,410.5516028367901)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.296148139681572"
          >
            <title>0% from Chamarajanagara</title>
          </circle>
          <circle
            transform="translate(118.33406808272619,414.3706623038543)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="17.674840876228558"
          >
            <title>2.6% from Wayanad</title>
          </circle>
          <circle
            transform="translate(114.35303166795799,417.6994454028474)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="19.794948850653793"
          >
            <title>3.2% from Kozhikode</title>
          </circle>
          <circle
            transform="translate(119.12167868176815,422.9319432500789)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="15.139352694220449"
          >
            <title>1.9% from Malappuram</title>
          </circle>
          <circle
            transform="translate(125.00497705619166,428.0730613569966)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="22.948638303829707"
          >
            <title>4.3% from Palakkad</title>
          </circle>
          <circle
            transform="translate(121.52041906619165,432.94099753162953)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="18.2822318112423"
          >
            <title>2.7% from Thrissur</title>
          </circle>
          <circle
            transform="translate(132.35430422376808,442.20384198103517)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="22.446380554557116"
          >
            <title>4.1% from Idukki</title>
          </circle>
          <circle
            transform="translate(124.8595592999278,438.73305256952347)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="35.0234207352737"
          >
            <title>10% from Ernakulam</title>
          </circle>
          <circle
            transform="translate(123.53153762862176,448.66325589556163)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.709734106958553"
          >
            <title>0.5% from Alappuzha</title>
          </circle>
          <circle
            transform="translate(126.28023313691838,445.3000573847475)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="20.69009424821453"
          >
            <title>3.5% from Kottayam</title>
          </circle>
          <circle
            transform="translate(130.60838476820888,450.5482970494581)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="24.232209969377536"
          >
            <title>4.8% from Pathanamthitta</title>
          </circle>
          <circle
            transform="translate(129.62988303520862,455.43782423778276)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="18.84887264533346"
          >
            <title>2.9% from Kollam</title>
          </circle>
          <circle
            transform="translate(131.76776232862255,460.6875956567994)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="29.069571720271355"
          >
            <title>6.9% from Thiruvananthapuram</title>
          </circle>
          <circle
            transform="translate(195.95039452560692,335.0028642098514)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.732863826479693"
          >
            <title>0.2% from West Godavari</title>
          </circle>
          <circle
            transform="translate(195.93268924115847,305.21410029637906)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Dakshin Bastar Dantewada</title>
          </circle>
          <circle
            transform="translate(203.18830442478992,301.7826611808671)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.6248076809271919"
          >
            <title>0% from Bastar</title>
          </circle>
          <circle
            transform="translate(200.15796595718624,291.4899606076391)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Kondagaon</title>
          </circle>
          <circle
            transform="translate(208.5416186721331,280.4931181934449)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Gariaband</title>
          </circle>
          <circle
            transform="translate(202.46044565019625,267.2940731764921)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.8761663039293717"
          >
            <title>0% from Raipur</title>
          </circle>
          <circle
            transform="translate(196.02190315163583,268.3697635632194)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.078460969082653"
          >
            <title>0% from Durg</title>
          </circle>
          <circle
            transform="translate(77.4515970938652,297.4555105991597)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="10.917875251164944"
          >
            <title>1% from Thane</title>
          </circle>
          <circle
            transform="translate(301.0330621587859,253.7261772961615)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.32666363360568"
          >
            <title>0.4% from South 24 Parganas</title>
          </circle>
          <circle
            transform="translate(247.84778235192337,271.95603611227284)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.296148139681572"
          >
            <title>0% from Angul</title>
          </circle>
          <circle
            transform="translate(202.24886137847008,278.7976320727438)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Dhamtari</title>
          </circle>
          <circle
            transform="translate(272.8962818541099,278.77822039202067)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.244994432064365"
          >
            <title>0% from Kendrapara</title>
          </circle>
          <circle
            transform="translate(73.65525213560367,284.27008198140777)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Dadra And Nagar Haveli</title>
          </circle>
          <circle
            transform="translate(72.88015824246155,290.6979393069101)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.71314274283428"
          >
            <title>0.3% from Palghar</title>
          </circle>
          <circle
            transform="translate(244.39807367861974,293.4078565781633)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3266499161421599"
          >
            <title>0% from Ganjam</title>
          </circle>
          <circle
            transform="translate(236.87555225474662,300.22939918468967)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.1999999999999997"
          >
            <title>0% from Gajapati</title>
          </circle>
          <circle
            transform="translate(157.72858639218222,372.69813019971735)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.4494897427831783"
          >
            <title>0% from Y.s.r. Kadapa</title>
          </circle>
          <circle
            transform="translate(130.73561979326138,387.01801712724654)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.808326112068523"
          >
            <title>0.2% from Tumakuru</title>
          </circle>
          <circle
            transform="translate(161.06175606575204,387.86661372879007)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="8.217055433669655"
          >
            <title>0.6% from Chittoor</title>
          </circle>
          <circle
            transform="translate(136.49040253139611,399.72009191687886)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.0954451150103321"
          >
            <title>0% from Ramanagara</title>
          </circle>
          <circle
            transform="translate(128.51710555520336,400.69970950464125)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.4331050121192876"
          >
            <title>0% from Mandya</title>
          </circle>
          <circle
            transform="translate(123.4585245630011,406.8118342228675)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.931531202375182"
          >
            <title>0.2% from Mysuru</title>
          </circle>
          <circle
            transform="translate(109.92121744280618,410.01553586812514)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="16.519079877523446"
          >
            <title>2.2% from Kannur</title>
          </circle>
          <circle
            ...
            r="4.569463863518345"
          >
            <title>0.2% from Puducherry</title>
          </circle>
          <circle
            transform="translate(193.05134186935243,275.89519756807175)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Balod</title>
          </circle>
          <circle
            transform="translate(76.30986344771632,252.15750662234257)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.6970562748477138"
          >
            <title>0% from Vadodara</title>
          </circle>
          <circle
            transform="translate(284.73509928955775,248.99902081377238)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.507771067833858"
          >
            <title>0.2% from Paschim Medinipur</title>
          </circle>
          <circle
            transform="translate(171.10391103993308,250.96109697145585)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Seoni</title>
          </circle>
          <circle
            transform="translate(92.77914861428742,250.99641669417497)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Alirajpur</title>
          </circle>
          <circle
            transform="translate(158.79241712952503,254.00097662032655)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Chhindwara</title>
          </circle>
          <circle
            transform="translate(133.32976815163687,252.3248782109887)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Harda</title>
          </circle>
          <circle
            transform="translate(113.48725406788591,257.2994366185832)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.0954451150103321"
          >
            <title>0% from Khargone</title>
          </circle>
          <circle
            transform="translate(289.9616023205261,255.5169334418007)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.4871191548325386"
          >
            <title>0.1% from Purba Medinipur</title>
          </circle>
          <circle
            transform="translate(269.89951726412494,257.6476098820219)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.3704599092705436"
          >
            <title>0.1% from Mayurbhanj</title>
          </circle>
          <circle
            transform="translate(241.85477769055947,254.73807031763147)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.529822128134703"
          >
            <title>0.1% from Sundargarh</title>
          </circle>
          <circle
            transform="translate(193.67929113044045,254.42446982854693)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Kabeerdham</title>
          </circle>
          <circle
            transform="translate(125.16851067286088,257.05682176856084)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Khandwa</title>
          </circle>
          <circle
            transform="translate(180.97397198159695,257.8526501583202)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            ...
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="0.8485281374238569"
          >
            <title>0% from Barwani</title>
          </circle>
          <circle
            transform="translate(215.7488922150913,257.0835396244699)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6"
          >
            <title>0% from Janjgir Champa</title>
          </circle>
          <circle
            transform="translate(90.61357349378976,263.10706236105915)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Nandurbar</title>
          </circle>
          <circle
            transform="translate(259.5528805693954,263.3669911996589)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Kendujhar</title>
          </circle>
          <circle
            transform="translate(277.2974066676505,264.0000716501089)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            ...
            r="0.282842712474619"
          >
            <title>0% from Bametara</title>
          </circle>
          <circle
            transform="translate(187.74937478551544,270.9952238482683)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Rajnandgaon</title>
          </circle>
          <circle
            transform="translate(139.91720731050927,268.8884660200668)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.16619037896906"
          >
            <title>0% from Amravati</title>
          </circle>
          <circle
            transform="translate(73.85031141130096,267.6642051280275)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6248076809271919"
          >
            <title>0% from Surat</title>
          </circle>
          <circle
            transform="translate(96.24041639565682,270.0780823707565)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Dhule</title>
          </circle>
          <circle
            transform="translate(224.86066375701918,268.3881820095822)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.5231546211727816"
          >
            <title>0% from Bargarh</title>
          </circle>
          <circle
            transform="translate(162.19940281774882,268.96792270363414)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.4331050121192876"
          >
            <title>0% from Nagpur</title>
          </circle>
          <circle
            transform="translate(209.87807507495575,262.6722282867656)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Baloda Bazar</title>
          </circle>
          <circle
            transform="translate(201.0891463511433,252.37448654579737)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Mungeli</title>
          </circle>
          <circle
            transform="translate(39.969899839230855,272.34695390722305)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Gir Somnath</title>
          </circle>
          <circle
            transform="translate(277.87865595420595,250.3218135642711)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.8973665961010278"
          >
            <title>0% from Jhargram</title>
          </circle>
          <circle
            transform="translate(39.68706513620059,255.56813441301466)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Rajkot</title>
          </circle>
          <circle
            transform="translate(56.73199027003222,262.51464803117176)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Bhavnagar</title>
          </circle>
          <circle
            transform="translate(144.39377362088607,257.83871989295466)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.7435595774162693"
          >
            <title>0% from Betul</title>
          </circle>
          <circle
            transform="translate(34.63178960301149,265.8563999495022)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Junagadh</title>
          </circle>
          <circle
            transform="translate(245.95885211195557,264.3767916767701)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.8547236990991407"
          >
            <title>0% from Deogarh</title>
          </circle>
          <circle
            transform="translate(31.705369923051684,250.71607994113083)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Jamnagar</title>
          </circle>
          <circle
            transform="translate(106.17803717295277,287.1110607422388)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.006662967072483"
          >
            <title>0.3% from Aurangabad</title>
          </circle>
          <circle
            transform="translate(116.05624765590379,337.12232420324517)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Vijayapura</title>
          </circle>
          <circle
            transform="translate(187.14081842186795,305.5527781317967)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Bijapur</title>
          </circle>
          <circle
            transform="translate(75.93234315281354,310.597266176859)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.161005515987263"
          >
            <title>0.4% from Raigad</title>
          </circle>
          <circle
            transform="translate(224.212963548127,254.77272624671775)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.0954451150103321"
          >
            <title>0% from Raigarh</title>
          </circle>
          <circle
            transform="translate(206.09524930101017,249.60555065581246)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3564659966250534"
          >
            <title>0% from Bilaspur</title>
          </circle>
          <circle
            transform="translate(172.70581732132345,425.9398104381621)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.6532998322843198"
          >
            <title>0.1% from Karaikal</title>
          </circle>
          <circle
            transform="translate(110.14993133644964,414.08223124004394)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.465765601187591"
          >
            <title>0% from Mahe</title>
          </circle>
          <circle
            transform="translate(208.51960810275332,338.3158212866376)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Yanam</title>
          </circle>
          <circle
            transform="translate(238.54471913241593,264.6553819865845)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.7712812921102032"
          >
            <title>0.1% from Sambalpur</title>
          </circle>
          <circle
            transform="translate(74.20691487640873,274.76155166109845)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8944271909999159"
          >
            <title>0% from Navsari</title>
          </circle>
          <circle
            transform="translate(195.46479118576985,314.6046965025891)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Sukma</title>
          </circle>
          <circle
            transform="translate(415.94712948930095,169.1642746928414)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(351.5225030758487,164.31638443370602)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(375.4252780138548,170.4094437278826)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Papum Pare</title>
          </circle>
          <circle
            transform="translate(404.02482193924595,174.77725146256756)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(396.48258756238755,180.38572844319353)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Mon</title>
          </circle>
          <circle
            transform="translate(393.23684117718557,182.49670269932454)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Longleng</title>
          </circle>
          <circle
            transform="translate(389.35685573901884,183.85192033899622)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.574801574802362"
          >
            <title>0% from Mokokchung</title>
          </circle>
          <circle
            transform="translate(394.55353762980224,188.68742244018352)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Tuensang</title>
          </circle>
          <circle
            transform="translate(393.49865372406197,193.961141210944)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Kiphire</title>
          </circle>
          <circle
            transform="translate(350.33880460605565,193.67170441538283)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3856406460551016"
          >
            <title>0% from Ribhoi</title>
          </circle>
          <circle
            transform="translate(341.1652706822776,198.0664281742212)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(375.86442890229836,199.90647246071387)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Peren</title>
          </circle>
          <circle
            transform="translate(358.90900387355896,203.6767733983002)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(349.10655520511483,201.64862889577063)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.766550115125193"
          >
            <title>0.2% from East Khasi Hills</title>
          </circle>
          <circle
            transform="translate(331.17950852317597,203.0182716759275)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(355.13269643464577,222.27533950709883)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8944271909999159"
          >
            <title>0% from North Tripura</title>
          </circle>
          <circle
            transform="translate(350.9609723129054,226.60009856500935)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Dhalai</title>
          </circle>
          <circle
            transform="translate(342.1987749356986,230.6004598714072)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            ...
            r="1.019803902718557"
          >
            <title>0% from Gomati</title>
          </circle>
          <circle
            transform="translate(384.45595298090143,188.2700339449043)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            ...
            r="0.6928203230275508"
          >
            <title>0% from Phek</title>
          </circle>
          <circle
            transform="translate(325.5899067362938,197.36339330934078)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(383.07158867628567,195.32795512316468)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.8110770276274832"
          >
            <title>0% from Kohima</title>
          </circle>
          <circle
            transform="translate(378.36075553755256,195.3324573695721)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.8705400188814645"
          >
            <title>0.1% from Dimapur</title>
          </circle>
          <circle
            transform="translate(401.3889377836282,157.97275847771485)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from East Siang</title>
          </circle>
          <circle
            transform="translate(415.0098090587549,160.27326262123665)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(378.34461463383485,165.9051604707655)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(357.80247710662536,170.29158227197132)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.019803902718557"
          >
            <title>0% from West Kameng</title>
          </circle>
          <circle
            transform="translate(356.2766112352764,199.9548987107844)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.4966629547095767"
          >
            <title>0% from West Jaintia Hills</title>
          </circle>
          <circle
            transform="translate(340.851520518886,202.661218090298)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(332.6281737186708,193.9021015360595)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(322.59186941703854,200.64238918837822)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(346.9976715787061,224.89949673810088)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Khowai</title>
          </circle>
          <circle
            transform="translate(343.21552528787885,225.9970973816222)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.3832750575625967"
          >
            <title>0% from West Tripura</title>
          </circle>
          <circle
            transform="translate(346.3773257088156,236.98145202490866)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from South Tripura</title>
          </circle>
          <circle
            transform="translate(352.72548558018235,220.87427250447044)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(411.5774456564997,163.58858853147657)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(400.96796194138585,177.6271595716406)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(408.59100442410767,154.40700356974236)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.1999999999999997"
          >
            <title>0% from Lower Dibang Valley</title>
          </circle>
          <circle
            transform="translate(385.3578729853342,147.2996097451713)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(390.6657985078566,155.97101664478987)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from West Siang</title>
          </circle>
          <circle
            transform="translate(151.14884762291265,145.10780898799538)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Amroha</title>
          </circle>
          <circle
            transform="translate(133.22602344237674,147.82858416482105)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.276362383309168"
          >
            <title>0.2% from Delhi</title>
          </circle>
          <circle
            transform="translate(126.44253221094772,148.48376232937474)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Jhajjar</title>
          </circle>
          <circle
            transform="translate(167.27141862945658,150.8989085565977)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Bareilly</title>
          </circle>
          <circle
            transform="translate(175.6086428922422,149.7569251621315)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Pilibhit</title>
          </circle>
          <circle
            transform="translate(139.69359337206097,152.15288117585385)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8944271909999159"
          >
            <title>0% from Gautam Buddha Nagar</title>
          </circle>
          <circle
            transform="translate(185.47685891398365,156.56827313223133)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Lakhimpur Kheri</title>
          </circle>
          <circle
            transform="translate(130.71151963609148,152.44468332013503)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.039607805437114"
          >
            <title>0% from Gurugram</title>
          </circle>
          <circle
            transform="translate(136.56440494501354,152.6859432575536)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.5231546211727816"
          >
            <title>0% from Faridabad</title>
          </circle>
          <circle
            transform="translate(132.29670941137118,158.72834104309337)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Nuh</title>
          </circle>
          <circle
            transform="translate(173.0108264468811,159.4507195318318)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Shahjahanpur</title>
          </circle>
          <circle
            transform="translate(140.75039369300933,165.2209581908768)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Mathura</title>
          </circle>
          <circle
            transform="translate(112.62750160065683,175.61250257980126)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.1999999999999997"
          >
            <title>0% from Jaipur</title>
          </circle>
          <circle
            transform="translate(69.5869242209865,179.34991076016766)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Jodhpur</title>
          </circle>
          <circle
            transform="translate(188.17685951673454,166.64279797779184)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Sitapur</title>
          </circle>
          <circle
            transform="translate(156.9019555170851,166.60634727774726)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Etah</title>
          </circle>
          <circle
            transform="translate(167.67231130562024,168.10897799680328)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Farrukhabad</title>
          </circle>
          <circle
            transform="translate(195.2614973691532,176.1894927795647)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Barabanki</title>
          </circle>
          <circle
            transform="translate(297.1330812889796,177.7448657498144)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.715930449020638"
          >
            <title>0.2% from Darjeeling</title>
          </circle>
          <circle
            transform="translate(171.0278176429096,174.94070512636983)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Kannauj</title>
          </circle>
          <circle
            transform="translate(188.94299376596848,177.79525215592855)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3564659966250534"
          >
            <title>0% from Lucknow</title>
          </circle>
          <circle
            transform="translate(304.50658520102775,180.3791279151443)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.5099857549568485"
          >
            <title>0.1% from Jalpaiguri</title>
          </circle>
          <circle
            transform="translate(214.23209377261807,178.16262520059132)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Basti</title>
          </circle>
          <circle
            transform="translate(224.99953288488402,180.80614596705425)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Gorakhpur</title>
          </circle>
          <circle
            transform="translate(248.0266112851947,181.40843938843773)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from East Champaran</title>
          </circle>
          <circle
            transform="translate(178.67495612370885,185.1732091680117)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Kanpur Nagar</title>
          </circle>
          <circle
            transform="translate(144.3033692555815,184.75561914676604)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Morena</title>
          </circle>
          <circle
            transform="translate(50.33110024714019,195.9417280681124)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Barmer</title>
          </circle>
          <circle
            transform="translate(156.9216462249382,184.77718546233223)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Bhind</title>
          </circle>
          <circle
            transform="translate(214.85808490386484,184.68303612028)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Ambedkar Nagar</title>
          </circle>
          <circle
            transform="translate(166.64032870695777,190.2761110586478)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Jalaun</title>
          </circle>
          <circle
            transform="translate(220.6927593275686,190.85514153063383)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Azamgarh</title>
          </circle>
          <circle
            transform="translate(148.23763279451822,190.9450645415557)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="1.9183326093250876"
          >
            <title>0% from Gwalior</title>
          </circle>
          <circle
            transform="translate(131.58055933583495,195.6898695362073)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Sheopur</title>
          </circle>
          <circle
            transform="translate(228.03173753997157,190.78014435288898)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Mau</title>
          </circle>
          <circle
            transform="translate(187.53432604226805,193.59022446520805)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Fatehpur</title>
          </circle>
          <circle
            transform="translate(261.8403406890108,195.28977359146788)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Samastipur</title>
          </circle>
          <circle
            transform="translate(160.15217162600896,199.71245749867313)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Jhansi</title>
          </circle>
          <circle
            transform="translate(143.47439185769267,201.90802712181275)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9797958971132712"
          >
            <title>0% from Shivpuri</title>
          </circle>
          <circle
            transform="translate(118.35841064203825,206.0083270199613)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Kota</title>
          </circle>
          <circle
            transform="translate(183.73878309313847,200.2184088345886)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Banda</title>
          </circle>
          <circle
            transform="translate(196.43279497396284,199.72572358591478)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Kaushambi</title>
          </circle>
          <circle
            transform="translate(204.51799259882986,202.95235585286946)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Prayagraj</title>
          </circle>
          <circle
            transform="translate(301.64771446656334,201.92254014740115)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.4176014981270124"
          >
            <title>0.1% from Dakshin Dinajpur</title>
          </circle>
          <circle
            transform="translate(294.5097537905115,205.54066065204307)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.814249455894058"
          >
            <title>0.1% from Malda</title>
          </circle>
          <circle
            transform="translate(161.14668029115145,209.7562616619248)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Tikamgarh</title>
          </circle>
          <circle
            transform="translate(218.56818018400378,201.50551309432547)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Varanasi</title>
          </circle>
          <circle
            transform="translate(127.8950326334924,207.86628243798157)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Baran</title>
          </circle>
          <circle
            transform="translate(234.80766411070792,208.24055879645826)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Rohtas</title>
          </circle>
          <circle
            transform="translate(154.54730986443823,213.48453663363327)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Lalitpur</title>
          </circle>
          <circle
            transform="translate(104.22185453605178,214.59169404248536)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Neemuch</title>
          </circle>
          <circle
            transform="translate(199.03947179329606,211.82342345907531)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Rewa</title>
          </circle>
          <circle
            transform="translate(187.9719608492007,215.39010671723986)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Satna</title>
          </circle>
          <circle
            transform="translate(134.41905367284258,215.1422989414738)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Guna</title>
          </circle>
          <circle
            transform="translate(257.89434845583196,210.90520326419846)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Nawada</title>
          </circle>
          <circle
            transform="translate(296.5924157683032,221.23045905181908)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.1908902300206643"
          >
            <title>0% from Murshidabad</title>
          </circle>
          <circle
            transform="translate(288.33651597237747,215.02496713912475)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Pakur</title>
          </circle>
          <circle
            transform="translate(108.10191277281889,220.83062971946651)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Mandsaur</title>
          </circle>
          <circle
            transform="translate(211.22464130869972,220.5595746164586)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.019803902718557"
          >
            <title>0% from Singrauli</title>
          </circle>
          <circle
            transform="translate(288.2925777030538,224.688092135223)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="3.8366652186501753"
          >
            <title>0.1% from Birbhum</title>
          </circle>
          <circle
            transform="translate(274.662349310183,218.6948400862946)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Deoghar</title>
          </circle>
          <circle
            transform="translate(247.3612412486633,221.13360511163265)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Chatra</title>
          </circle>
          <circle
            transform="translate(157.38990228409924,226.3195649951302)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.4979991993593593"
          >
            <title>0.1% from Sagar</title>
          </circle>
          <circle
            transform="translate(168.72675922155696,227.05164481191673)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.7276363393971708"
          >
            <title>0.1% from Damoh</title>
          </circle>
          <circle
            transform="translate(125.21976786623176,234.14476387919197)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Shajapur</title>
          </circle>
          <circle
            transform="translate(143.49381926434657,225.7645584903996)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Vidisha</title>
          </circle>
          <circle
            transform="translate(127.59805757479208,226.24794955731005)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.315167380558045"
          >
            <title>0% from Rajgarh</title>
          </circle>
          <circle
            transform="translate(197.31771314627164,229.9544590742487)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8485281374238569"
          >
            <title>0% from Shahdol</title>
          </circle>
          <circle
            transform="translate(300.82859527972465,232.27270770950017)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.796550698475775"
          >
            <title>0.3% from Nadia</title>
          </circle>
          <circle
            transform="translate(277.15752109349233,224.33520358299654)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Jamtara</title>
          </circle>
          <circle
            transform="translate(181.66331827903056,228.02949113571435)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Katni</title>
          </circle>
          <circle
            transform="translate(270.87140005449953,226.78698859128207)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9380831519646858"
          >
            <title>0% from Dhanbad</title>
          </circle>
          <circle
            transform="translate(190.02244575824196,231.05361247136656)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Umaria</title>
          </circle>
          <circle
            transform="translate(103.31147674803262,232.12075046819785)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.7204650534085253"
          >
            <title>0% from Ratlam</title>
          </circle>
          <circle
            transform="translate(263.8208624784272,228.91654737505448)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Bokaro</title>
          </circle>
          <circle
            transform="translate(257.38072873784233,229.97879255846436)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9797958971132712"
          >
            <title>0% from Ramgarh</title>
          </circle>
          <circle
            transform="translate(137.29417334589698,232.57627016422876)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.059702963017246"
          >
            <title>0.3% from Bhopal</title>
          </circle>
          <circle
            transform="translate(292.54511295147154,234.39010048331883)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.18568990729127"
          >
            <title>0.1% from Purba Bardhaman</title>
          </circle>
          <circle
            transform="translate(208.48691221446273,232.53349175819258)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Koriya</title>
          </circle>
          <circle
            transform="translate(111.9571161036791,234.77700974613168)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9380831519646858"
          >
            <title>0% from Ujjain</title>
          </circle>
          <circle
            transform="translate(61.61424463104064,243.6473395472137)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.649242250247064"
          >
            <title>0% from Ahmedabad</title>
          </circle>
          <circle
            transform="translate(147.9775818023037,236.49902225278)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Raisen</title>
          </circle>
          <circle
            transform="translate(270.1030182252223,235.6070387590796)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3564659966250534"
          >
            <title>0% from Purulia</title>
          </circle>
          <circle
            transform="translate(133.37200588897247,240.28416296387076)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Sehore</title>
          </circle>
          <circle
            transform="translate(254.55382607310196,234.80073380048492)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6970562748477138"
          >
            <title>0% from Ranchi</title>
          </circle>
          <circle
            transform="translate(280.55988321099954,237.86283840426574)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4"
          >
            <title>0.1% from Bankura</title>
          </circle>
          <circle
            transform="translate(175.24525148692,236.29374955514152)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.127953488110058"
          >
            <title>0.1% from Jabalpur</title>
          </circle>
          <circle
            transform="translate(242.19324163652206,238.44498658607318)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Gumla</title>
          </circle>
          <circle
            transform="translate(200.46368223238716,239.16414058070612)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8485281374238569"
          >
            <title>0% from Anuppur</title>
          </circle>
          <circle
            transform="translate(97.26776025699532,241.85462721923633)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Jhabua</title>
          </circle>
          <circle
            transform="translate(304.0365442140351,244.3802168797937)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="10.303397497913007"
          >
            <title>0.9% from North 24 Parganas</title>
          </circle>
          <circle
            transform="translate(191.0184721891713,241.777033766322)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6928203230275508"
          >
            <title>0% from Dindori</title>
          </circle>
          <circle
            transform="translate(294.3175366293969,242.0555976913887)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="7.266360849833981"
          >
            <title>0.4% from Hooghly</title>
          </circle>
          <circle
            transform="translate(162.31123551486527,241.01844067898892)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.019803902718557"
          >
            <title>0% from Narsinghpur</title>
          </circle>
          <circle
            transform="translate(103.65742348970126,248.0436243545697)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.078460969082653"
          >
            <title>0% from Dhar</title>
          </circle>
          <circle
            transform="translate(232.3730553475479,243.30661647083957)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Jashpur</title>
          </circle>
          <circle
            transform="translate(113.62256306406613,244.65663479613272)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.858327406350724"
          >
            <title>0.3% from Indore</title>
          </circle>
          <circle
            transform="translate(263.2316935987395,242.4394526973842)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Saraikela-kharsawan</title>
          </circle>
          <circle
            transform="translate(183.19463024572354,245.85639589168414)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Mandla</title>
          </circle>
          <circle
            transform="translate(270.3900529914671,246.67718664980416)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.296148139681572"
          >
            <title>0% from East Singhbhum</title>
          </circle>
          <circle
            transform="translate(146.27123981090296,246.50694321069702)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.2328828005937955"
          >
            <title>0% from Hoshangabad</title>
          </circle>
          <circle
            transform="translate(213.99566230558426,247.4536428923284)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.7663521732655694"
          >
            <title>0% from Korba</title>
          </circle>
          <circle
            transform="translate(256.82134083509845,249.2794336574766)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from West Singhbhum</title>
          </circle>
          <circle
            transform="translate(294.2881584327467,247.75801932087148)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="7.2993150363578625"
          >
            <title>0.4% from Howrah</title>
          </circle>
          <circle
            transform="translate(298.3684606573543,247.16438042456807)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="13.39552163971228"
          >
            <title>1.5% from Kolkata</title>
          </circle>
          <circle
            transform="translate(255.2679794536537,223.13260171357632)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Hazaribagh</title>
          </circle>
          <circle
            transform="translate(254.55769512308265,195.4974795121127)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Vaishali</title>
          </circle>
          <circle
            transform="translate(265.759645227794,199.80694908745568)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Begusarai</title>
          </circle>
          <circle
            transform="translate(252.52190644807263,200.50840028100743)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3266499161421599"
          >
            <title>0% from Patna</title>
          </circle>
          <circle
            transform="translate(246.5299387521269,193.18653819414794)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Saran</title>
          </circle>
          <circle
            transform="translate(277.1781780454725,194.66872858130878)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Madhepura</title>
          </circle>
          <circle
            transform="translate(283.9270884679786,188.36052763840104)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Araria</title>
          </circle>
          <circle
            transform="translate(267.1156073874425,185.03108058683216)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Madhubani</title>
          </circle>
          <circle
            transform="translate(223.07182359708992,241.2659271528803)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Surguja</title>
          </circle>
          <circle
            transform="translate(199.6927077884556,186.8477474564624)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Amethi</title>
          </circle>
          <circle
            transform="translate(138.38047033917735,145.7905828297712)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Ghaziabad</title>
          </circle>
          <circle
            transform="translate(154.39289460646725,151.01231383777377)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Sambhal</title>
          </circle>
          <circle
            transform="translate(314.70723001915087,181.27552708408228)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.9183326093250876"
          >
            <title>0% from Alipurduar</title>
          </circle>
          <circle
            transform="translate(280.8658035131357,229.42389404973883)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.363484845854285"
          >
            <title>0.2% from Paschim Bardhaman</title>
          </circle>
          <circle
            transform="translate(302.49835039958174,174.6695813768195)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6"
          >
            <title>0% from Kalimpong</title>
          </circle>
          <circle
            transform="translate(98.61414946752366,187.85211545463343)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Ajmer</title>
          </circle>
          <circle
            transform="translate(313.34410253855845,186.80038676609107)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.072458299147443"
          >
            <title>0.1% from Cooch Behar</title>
          </circle>
          <circle
            transform="translate(295.59480809352243,193.3601913622991)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.2090722034374517"
          >
            <title>0% from Uttar Dinajpur</title>
          </circle>
          <circle
            transform="translate(155.05090607800284,194.72544046169364)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Datia</title>
          </circle>
          <circle
            transform="translate(170.78110865261735,211.04688995118443)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9797958971132712"
          >
            <title>0% from Chhatarpur</title>
          </circle>
          <circle
            transform="translate(178.49204850158478,217.32231051593865)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.1999999999999997"
          >
            <title>0% from Panna</title>
          </circle>
          <circle
            transform="translate(73.2157724760646,227.3030364386133)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Sabarkantha</title>
          </circle>
          <circle
            transform="translate(27.199314747263124,229.68995292151453)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9797958971132712"
          >
            <title>0% from Kutch</title>
          </circle>
          <circle
            transform="translate(69.59996280896637,248.61968025115976)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Anand</title>
          </circle>
          <circle
            transform="translate(292.4033463046182,186.8112654156018)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Kishanganj</title>
          </circle>
          <circle
            transform="translate(128.44137520504174,36.73195039644909)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.2271057451320084"
          >
            <title>0% from Leh</title>
          </circle>
          <circle
            transform="translate(124.1171653781872,57.38546958716332)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Kargil</title>
          </circle>
          <circle
            transform="translate(90.59056032044784,46.26665128384246)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.5231546211727816"
          >
            <title>0% from Kupwara</title>
          </circle>
          <circle
            transform="translate(100.26119063062707,46.870963521218165)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.2328828005937955"
          >
            <title>0% from Bandipora</title>
          </circle>
          <circle
            transform="translate(91.95138287053227,52.723013456867605)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.286335345030996"
          >
            <title>0.1% from Baramulla</title>
          </circle>
          <circle
            transform="translate(102.56229330468565,50.62197560100859)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.8761663039293717"
          >
            <title>0% from Ganderbal</title>
          </circle>
          <circle
            transform="translate(106.87303422085206,58.641880503420296)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.2649110640673515"
          >
            <title>0% from Anantnag</title>
          </circle>
          <circle
            transform="translate(116.33816370253719,63.54352967256176)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Kishtwar</title>
          </circle>
          <circle
            transform="translate(100.93214283766432,53.52912689435767)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="6.006662967072483"
          >
            <title>0.3% from Srinagar</title>
          </circle>
          <circle
            transform="translate(96.85951232303182,56.94689261075139)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            stroke="rgba(0, 123, 255, 0.4392156862745098)"
            r="2.6683328128252666"
          >
            <title>0.1% from Budgam</title>
          </circle>
          <circle
            transform="translate(102.38183115446901,56.704125243796504)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8485281374238569"
          >
            <title>0% from Pulwama</title>
          </circle>
          <circle
            transform="translate(87.68024603907415,59.109334042405465)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.019803902718557"
          >
            <title>0% from Punch</title>
          </circle>
          <circle
            transform="translate(99.89877879730695,62.63813980392077)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Kulgam</title>
          </circle>
          <circle
            transform="translate(93.13999992038163,68.47915798360636)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Rajouri</title>
          </circle>
          <circle
            transform="translate(104.96650936825273,67.51339193481442)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.6324555320336758"
          >
            <title>0% from Ramban</title>
          </circle>
          <circle
            transform="translate(99.96022479198017,69.30813325517892)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Reasi</title>
          </circle>
          <circle
            transform="translate(112.51090607037712,71.6757927687578)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6"
          >
            <title>0% from Doda</title>
          </circle>
          <circle
            transform="translate(121.97287113597159,78.79996067157896)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6248076809271919"
          >
            <title>0% from Chamba</title>
          </circle>
          <circle
            transform="translate(98.46884650605223,76.79914041049027)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.649242250247064"
          >
            <title>0% from Jammu</title>
          </circle>
          <circle
            transform="translate(106.41174671448869,92.22265447687695)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Gurdaspur</title>
          </circle>
          <circle
            transform="translate(121.49041668622142,88.74354566057362)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="8.084553172563094"
          >
            <title>0.5% from Kangra</title>
          </circle>
          <circle
            transform="translate(137.4112936285524,92.39511236867982)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6970562748477138"
          >
            <title>0% from Kullu</title>
          </circle>
          <circle
            transform="translate(114.74622819052564,97.18108850990565)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Hoshiarpur</title>
          </circle>
          <circle
            transform="translate(100.6313786514487,95.81995694933039)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3856406460551016"
          >
            <title>0% from Amritsar</title>
          </circle>
          <circle
            transform="translate(131.41588837082702,96.98006799385445)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.741657386773941"
          >
            <title>0.1% from Mandi</title>
          </circle>
          <circle
            transform="translate(152.17880304403374,97.56075324125452)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Kinnaur</title>
          </circle>
          <circle
            transform="translate(119.92046132529367,97.87242133719427)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="4.089009660052175"
          >
            <title>0.1% from Una</title>
          </circle>
          <circle
            transform="translate(140.9572962061347,104.63855124695496)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.111269837220809"
          >
            <title>0.1% from Shimla</title>
          </circle>
          <circle
            transform="translate(110.60483540522081,104.2703136164442)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6970562748477138"
          >
            <title>0% from Jalandhar</title>
          </circle>
          <circle
            transform="translate(99.90303748455872,102.04191800941568)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Tarn Taran</title>
          </circle>
          <circle
            transform="translate(124.0047999224583,106.81784923753081)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3564659966250534"
          >
            <title>0% from Rupnagar</title>
          </circle>
          <circle
            transform="translate(155.14082805513726,108.37462729815779)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Uttarkashi</title>
          </circle>
          <circle
            transform="translate(130.21708989347562,107.1271757360107)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.574801574802362"
          >
            <title>0% from Solan</title>
          </circle>
          <circle
            transform="translate(118.98805382076881,105.98509294594136)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Shahid Bhagat Singh Nagar</title>
          </circle>
          <circle
            transform="translate(89.86873935921656,120.22287694716341)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Fazilka</title>
          </circle>
          <circle
            transform="translate(104.66888247964796,111.90366388356139)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Moga</title>
          </circle>
          <circle
            transform="translate(114.4147996222764,111.23703248549127)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.1999999999999997"
          >
            <title>0% from Ludhiana</title>
          </circle>
          <circle
            transform="translate(169.4251976653715,116.54772871346832)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.565685424949238"
          >
            <title>0% from Chamoli</title>
          </circle>
          <circle
            transform="translate(145.83026368510457,117.12721177967519)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="2.925747767665559"
          >
            <title>0.1% from Dehradun</title>
          </circle>
          <circle
            transform="translate(137.83271632979168,113.63078260454891)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Sirmaur</title>
          </circle>
          <circle
            transform="translate(127.67575836899302,113.22733367405563)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.469693845669907"
          >
            <title>0% from S.a.s. Nagar</title>
          </circle>
          <circle
            transform="translate(98.83753823246225,114.47172817429171)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8944271909999159"
          >
            <title>0% from Faridkot</title>
          </circle>
          <circle
            transform="translate(122.40137016446653,114.00113707290768)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Fatehgarh Sahib</title>
          </circle>
          <circle
            transform="translate(128.30354756267604,112.63399360291403)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.6970562748477138"
          >
            <title>0% from Chandigarh</title>
          </circle>
          <circle
            transform="translate(95.37210774721346,119.92500285124076)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Sri Muktsar Sahib</title>
          </circle>
          <circle
            transform="translate(180.79294079072025,122.8951231677351)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8485281374238569"
          >
            <title>0% from Pithoragarh</title>
          </circle>
          <circle
            transform="translate(114.92922294290263,121.337896357499)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Sangrur</title>
          </circle>
          <circle
            transform="translate(109.49864044396026,118.34834570223532)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8944271909999159"
          >
            <title>0% from Barnala</title>
          </circle>
          <circle
            transform="translate(102.74183267624306,121.71450749370419)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.1999999999999997"
          >
            <title>0% from Bathinda</title>
          </circle>
          <circle
            transform="translate(121.96552462204626,120.15816184713053)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.8"
          >
            <title>0% from Patiala</title>
          </circle>
          <circle
            transform="translate(136.01076614426486,120.9770651229425)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Yamunanagar</title>
          </circle>
          <circle
            transform="translate(139.64580937565606,125.76771825312598)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Saharanpur</title>
          </circle>
          <circle
            transform="translate(81.1500575488846,135.1884120053847)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Ganganagar</title>
          </circle>
          <circle
            transform="translate(128.2826094355225,124.31269492452033)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Kurukshetra</title>
          </circle>
          <circle
            transform="translate(173.6318027123591,125.23298535787232)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Bageshwar</title>
          </circle>
          <circle
            transform="translate(146.1587767333067,126.97651926752872)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.7483314773547883"
          >
            <title>0% from Haridwar</title>
          </circle>
          <circle
            transform="translate(157.43530496877102,126.95190599944026)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Pauri Garhwal</title>
          </circle>
          <circle
            transform="translate(100.78646031430532,131.4087478718065)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Sirsa</title>
          </circle>
          <circle
            transform="translate(130.05521316243247,130.22840650267733)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Karnal</title>
          </circle>
          <circle
            transform="translate(168.34741876211575,130.20580646854145)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Almora</title>
          </circle>
          <circle
            transform="translate(121.4771904618648,134.53734246831672)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Jind</title>
          </circle>
          <circle
            transform="translate(142.26459563093167,134.82100155280952)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Muzaffarnagar</title>
          </circle>
          <circle
            transform="translate(114.26401968892758,138.1811116468457)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Hisar</title>
          </circle>
          <circle
            transform="translate(167.81305484419318,136.48543953248253)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.058300524425836"
          >
            <title>0% from Nainital</title>
          </circle>
          <circle
            transform="translate(130.57767679337505,136.18501042066313)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Panipat</title>
          </circle>
          <circle
            transform="translate(176.78232172686785,137.1915089042741)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Champawat</title>
          </circle>
          <circle
            transform="translate(143.13723186640752,141.3053885142321)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.0954451150103321"
          >
            <title>0% from Meerut</title>
          </circle>
          <circle
            transform="translate(157.79503530554908,143.5940630255284)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.282842712474619"
          >
            <title>0% from Moradabad</title>
          </circle>
          <circle
            transform="translate(75.3165640887147,155.61197076734612)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Bikaner</title>
          </circle>
          <circle
            transform="translate(162.64018324139982,144.9010895327665)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Rampur</title>
          </circle>
          <circle
            transform="translate(124.66444834137151,143.28952111479126)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.2328828005937955"
          >
            <title>0% from Rohtak</title>
          </circle>
          <circle
            transform="translate(97.72118105762654,109.37173374168312)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.9380831519646858"
          >
            <title>0% from Ferozepur</title>
          </circle>
          <circle
            transform="translate(111.28550565710218,85.48627436263432)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.3266499161421599"
          >
            <title>0% from Pathankot</title>
          </circle>
          <circle
            transform="translate(106.60888282448694,74.9688585185749)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4898979485566356"
          >
            <title>0% from Udhampur</title>
          </circle>
          <circle
            transform="translate(107.80979397689262,101.81120954390256)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Kapurthala</title>
          </circle>
          <circle
            transform="translate(131.2302731073271,113.41288292610027)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="1.019803902718557"
          >
            <title>0% from Panchkula</title>
          </circle>
          <circle
            transform="translate(130.5785031935494,119.31395306977984)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Ambala</title>
          </circle>
          <circle
            transform="translate(227.1022031124684,230.67142807203362)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="0.4"
          >
            <title>0% from Balrampur</title>
          </circle>
          <circle
            transform="translate(210.53560296259138,167.10202415705945)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
          ...
          <circle
            transform="translate(124.61299633787924,96.40481241768332)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="5.291502622129181"
          >
            <title>0.2% from Hamirpur</title>
          </circle>
          <circle
            transform="translate(126.52685239236628,101.46266249600528)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
            ...
            r="3.666060555964672"
          >
            <title>0.1% from Bilaspur</title>
          </circle>
          <circle
            transform="translate(157.33370809032044,203.45281591173406)"
            fill-opacity="0.25"
            pointer-events="all"
            style={{ cursor: "pointer" }}
            fill="rgba(0, 123, 255, 0.4392156862745098)"
